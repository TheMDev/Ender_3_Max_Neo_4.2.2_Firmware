 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -40, -12, 0 } //ORIGINAL: #define NOZZLE_TO_PROBE_OFFSET { 10, 10, 0 } // (mm) X, Y, Z distance from Nozzle tip to Probe trigger-point
...
#define XY_PROBE_FEEDRATE (60*60) //ORIGINAL: #define XY_PROBE_FEEDRATE    (133*60) // (mm/min)
