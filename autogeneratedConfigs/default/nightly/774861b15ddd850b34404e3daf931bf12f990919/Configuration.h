...
#define TEMP_SENSOR_BED 1 //ORIGINAL: #define TEMP_SENSOR_BED 0
...
#define Z_PROBE_OFFSET_RANGE_MIN -10 //ORIGINAL: #define Z_PROBE_OFFSET_RANGE_MIN -20
#define Z_PROBE_OFFSET_RANGE_MAX 10 //ORIGINAL: #define Z_PROBE_OFFSET_RANGE_MAX 20
